            ...
            <section className="text-gray-600 body-font overflow-hidden">
                <div className="container px-5 py-24 mx-auto">
                    ...
                    <div className="flex mx-auto border-2 border-yellow-500 rounded overflow-hidden mt-6">
                        <button className="py-1 px-4 bg-yellow-500 text-white focus:outline-none">Monthly</button>
                    ...
                    <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
                        ...
                        <button className="flex items-center mt-auto text-white bg-yellow-500 border-0 py-2 px-4 w-full focus:outline-none hover:bg-yellow-600 rounded">Button
                            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4 ml-auto" viewBox="0 0 24 24">
                            <path d="M5 12h14M12 5l7 7-7 7"></path>
                            </svg>
                        </button>
